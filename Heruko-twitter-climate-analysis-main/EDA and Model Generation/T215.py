...
X_train, X_test, y_train, y_test = train_test_split(X, Y, test_size=0.10, shuffle=True, random_state=1103)
tfidf = TfidfVectorizer(ngram_range=(1, 3), max_features=30000, use_idf=True)
